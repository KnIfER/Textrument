...
#define NPPMSG  (WM_USER + 1000)
	...
	#define NPPM_GETPLUGINMENU (NPPMSG + 671)
	#define NPPM_OPENINTERNALEXTERNALPATH (NPPMSG + 672)
	#define NPPM_GETRAWFULLCURRENTPATH (NPPMSG + 673)
	#define NPPM_EMPTYEDITHISTORY (NPPMSG + 674)
	#define NPPM_CURRENTBINMODE (NPPMSG + 675)
	#define NPPM_ENABLEMENUITEM (NPPMSG + 676)
	#define NPPM_GETDOCUMENTPTR (NPPMSG + 677)
	#define NPPM_SETDOCKFOCUS (NPPMSG + 678)
	#define NPPM_CLOSEDOCK (NPPMSG + 679)
