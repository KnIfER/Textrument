...
#define	IDD_REGEXT_BOX 4000
	...
	#define IDC_REGISTER_STATIC        (IDD_REGEXT_BOX + 11)
	#define IDC_UNREGISTER_STATIC        (IDD_REGEXT_BOX + 12)
...
#define	IDD_PREFERENCE_BAR_BOX 6100 //(IDD_PREFERENCE_BOX + 100)
	...
	#define	IDC_CHECK_DOCSWITCH_EXTCOLUMN (IDD_PREFERENCE_BAR_BOX + 27)
	#define	IDC_CHECK_SHOWBIGGERFONTS (IDD_PREFERENCE_BAR_BOX + 28)
	#define IDC_CHECK_TAB_ALTICONS  (IDD_PREFERENCE_BAR_BOX + 29)
...
// #define	IDC_DISTRACTIONFREE_SLIDER (IDD_PREFERENCE_SUB_EDITING + 24)
	...
	#define	IDC_PADDINGLEFT_SLIDER (IDD_PREFERENCE_MARGEIN_BOX + 40)
	#define	IDC_PADDINGRIGHT_SLIDER (IDD_PREFERENCE_MARGEIN_BOX + 41)
	#define	IDC_PADDINGLEFTVAL_STATIC (IDD_PREFERENCE_MARGEIN_BOX + 42)
	#define	IDC_PADDINGRIGHTVAL_STATIC (IDD_PREFERENCE_MARGEIN_BOX + 43)
	#define	IDC_DISTRACTIONFREEVAL_STATIC (IDD_PREFERENCE_MARGEIN_BOX + 44)

	#define	IDC_BORDERXCompWIDTHVAL_STATIC (IDD_PREFERENCE_MARGEIN_BOX + 45)
	#define	IDC_BORDERXCompWIDTH_SLIDER (IDD_PREFERENCE_MARGEIN_BOX + 46)
...
#define	IDD_PREFERENCE_SETTING_BOX 6300 //(IDD_PREFERENCE_BOX + 300)
	...
	#define	IDC_CHECK_SAVEDLGEXTFILTALLTYPES (IDD_PREFERENCE_SETTING_BOX + 51)
	...
	#define	IDC_MARKALL_STATIC (IDD_PREFERENCE_SETTING_BOX + 51)
	#define	IDC_CHECK_MARKALLCASESENSITIVE (IDD_PREFERENCE_SETTING_BOX + 52)
	#define	IDC_CHECK_MARKALLWHOLEWORDONLY (IDD_PREFERENCE_SETTING_BOX + 53)
	#define	IDC_SMARTHILITEMATCHING_STATIC (IDD_PREFERENCE_SETTING_BOX + 54)

	#define	IDC_CHECK_MUTE_SOUNDS (IDD_PREFERENCE_SETTING_BOX + 60)
	#define	IDC_CHECK_SAVEALLCONFIRM (IDD_PREFERENCE_SETTING_BOX + 61)
...
#define	IDD_PREFERENCE_NEWDOCSETTING_BOX 6400 //(IDD_PREFERENCE_BOX + 400)
	...
	#define IDC_OPENSAVEDIR_GR_STATIC2 (IDD_PREFERENCE_NEWDOCSETTING_BOX + 32)
	#define IDC_OPENSAVEDIR_CHECK_DROPOPENFILTER (IDD_PREFERENCE_NEWDOCSETTING_BOX + 33)
	#define IDC_OPENSAVEDIR_CHECK_DROPOPENRECURSE (IDD_PREFERENCE_NEWDOCSETTING_BOX + 34)
	#define IDDROPFILTER (IDD_PREFERENCE_NEWDOCSETTING_BOX + 35)
...
#define IDD_PREFERENCE_SEARCHINGSETTINGS_BOX 6900 //(IDD_PREFERENCE_BOX + 900)
	...
	#define IDC_CHECK_ENLARGED_FINDDLG (IDD_PREFERENCE_SEARCHINGSETTINGS_BOX + 5)
	#define IDC_CHECK_FILLCARETFINDFIELD (IDD_PREFERENCE_SEARCHINGSETTINGS_BOX + 6)
	#define IDC_GROUP_FINDFIELD_STATIC (IDD_PREFERENCE_SEARCHINGSETTINGS_BOX + 7)
	#define IDC_CHECK_REPLACEANDSTOP (IDD_PREFERENCE_SEARCHINGSETTINGS_BOX + 8)
...
#define IDD_DIALOG_SHELLSETTINGS             17000
	#define IDC_CHECK_USECONTEXT            (IDD_DIALOG_SHELLSETTINGS + 1)
	#define IDC_CHECK_CONTEXTICON           (IDD_DIALOG_SHELLSETTINGS + 2)
	#define IDC_EDIT_MENU                   (IDD_DIALOG_SHELLSETTINGS + 3)
	#define IDC_EDIT_COMMAND                (IDD_DIALOG_SHELLSETTINGS + 4)
	#define IDC_CHECK_USEICON               (IDD_DIALOG_SHELLSETTINGS + 5)
	#define IDC_CHECK_ISDYNAMIC             (IDD_DIALOG_SHELLSETTINGS + 6)
