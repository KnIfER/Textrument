...
// To be updated if new menu item(s) is (are) added in menu "File"
    ...
    #define    IDM_FILE_OPEN_LINK             (IDM_FILE + 100)
...
//-----------
    ...
    #define    IDM_EDIT_COLUMNMODIDEA               (IDM_EDIT + 166)
...
//    #define    IDM_SETTING_EDGE_SIZE                (IDM_SETTING + 4)
	...
	#define	   IDM_SETTING_SMALLICON  	    (IDM_SETTING + 100)
	#define	   IDM_SETTING_BIGICON  	    (IDM_SETTING + 101)
	#define	   IDM_SETTING_STANDARDICON  	    (IDM_SETTING + 102)
	#define	   IDM_SETTING_HIDETOOLBAR  	    (IDM_SETTING + 103)
	#define	   IDM_SETTING_TOGGLESPLITPANELEQUAL  	    (IDM_SETTING + 104)
...
#define    IDM_DUMMY    (0x7fffffff - 100)
	...
	#define    IDM_DUMMY6    (IDM_DUMMY+5)
	#define    IDM_DUMMY7    (IDM_DUMMY+5)
	#define    IDM_DUMMY8    (IDM_DUMMY+5)
	#define    IDM_DUMMY9    (IDM_DUMMY+5)
	#define    IDM_DUMMY10    (IDM_DUMMY+5)
	#define    IDM_DUMMY11    (IDM_DUMMY+5)
	#define    IDM_DUMMY12    (IDM_DUMMY+5)
