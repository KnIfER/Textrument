...
//finder-copy
		action = pushActionByPathFieldedIDForFieldInTag("{ar:'نسخ', ga:'Cóipeáil', be:'Капіяваць', bg:'Копиране', pl:'Kopiuj', da:'Kopier', de:'Kopieren', ru:'Копировать', fr:'Copier', fi:'Kopioi', ko:'복사', nl:'Kopiëren', ca:'Copia', cs:'Kopírovat', co:'Cupià', hr:'Kopiraj', lt:'Kopijuoti', ro:'Copiere', zu:'Kopisha', ne:'कापी', ja:'コピー', sv:'Kopiera', sk:'Kopírovať', sl:'Kopiraj', tr:'Kopyala', uk:'Копіювати', uz:'Nusxalamoq', es:'Copiar', hu:'Másolás', it:'Copia', hi:'कॉपी करें', id:'Salin', en:'Copy', en1:'Copy', zh_CN:'复制', bre:'Eilañ', venetian:'Còpia', piglatin:'Opycay', taiwanese:'複製', pt_b:'Copiar'}", MODIFY, null, null, "value", "Item", "Native-Langue", "MiscStrings", "finder-copy");
